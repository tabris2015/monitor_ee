...
def populate():
    ...
    add_page(cat=django_cat,
        ...
        url="https://docs.djangoproject.com/en/1.5/intro/tutorial01/", views = 344)

    add_page(cat=django_cat,
        title="Django Rocks",
        url="http://www.djangorocks.com/", views = 33)
    ...
    add_page(cat=frame_cat,
        title="Flask",
        url="http://flask.pocoo.org", views = 3232)
...
#funcion de anadir categoria sobre los modelos
